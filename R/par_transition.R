...
#'
#' @name par_transition
#' @aliases par_transition
#' @aliases par_transition,RasterLayer-method
#' @aliases par_transition,RasterBrick-method
#' @keywords spatial
#' @family Transition
#' 
...
#'
#' \code{par_transition(x, transisitonFunction, directions, symm)}
#' 
...
#' 
#' The function \code{par_transition} does no commutativity check.
#' 
...
#' 
#' \code{par_transition(x, transitionFunction="mahal", directions)}
#' 
...
#' 
#' \code{par_transition(x, transitionFunction="barriers", 
...
#' 
#' \code{par_transition(x, transitionFunction="barriers", directions)}
#' 
...
#' 
#' \code{par_transition(x, transitionFunction="areas", directions)}
#' 
...
#' @exportMethod par_transition
setGeneric("par_transition", function(x, transitionFunction, directions, ...) standardGeneric("par_transition"))

#' @exportMethod par_transition
setMethod("par_transition", 
...
.TfromR <- function(x, transitionFunction, directions, symm)
{
  ...
  #plan(multiprocess, workers = 4) ## Parallelize using four cores
	...
	transition.values <- future_apply(dataVals,1,transitionFunction)
...
#' @export
setMethod("par_transition", signature(x = "RasterBrick"), 
